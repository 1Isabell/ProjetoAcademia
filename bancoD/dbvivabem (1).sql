...
(1, 'JOAO SILVA', '1990-01-15', 'joao@email.com', 'senha123', '2023-10-06', 'ATIVO', 'aluno/joãosilva1.png'),
(3, 'MARIA SANTOS', '1995-05-20', 'maria@email.com', 'senha456', '2023-10-06', 'ATIVO', 'aluno/mariasantos2.png'),
(4, 'CARLOS FERREIRA', '1988-08-10', 'carlos@email.com', 'senha789', '2023-10-06', 'ATIVO', 'aluno/carlosferreira3.png'),
(5, 'ANA OLIVEIRA', '1992-04-30', 'ana@email.com', 'senhaabc', '2023-10-06', 'ATIVO', 'aluno/anaoliveira4.png'),
(6, 'PEDRO RIBEIRO', '1985-11-25', 'pedro@email.com', 'senhaxyz', '2023-10-06', 'ATIVO', 'aluno/pedroribeiro5.png');
...
CREATE TABLE `tblexercicios` (
  ...
  `descricaoExercicio` varchar(150) NOT NULL,
...
(2, '(22)98765-4321', 'CLARO', 'RESIDENCIAL', 3),
(3, '(33)55555-555', 'TIM', 'CELULAR', 4),
(4, '(44)99999-9999', 'OI', 'CELULAR', 5),
(5, '(55)88888-8888', 'VIVO', 'COMERCIAL', 6);
...
--
ALTER TABLE `tblregistrotreinos`
  ADD CONSTRAINT `registroExercicio` FOREIGN KEY (`idExercicio`) REFERENCES `tblexercicios` (`idExercicio`),
